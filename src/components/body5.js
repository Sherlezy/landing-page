                    ...
                    <div className='wrapper-outside-body relative overlay-1 full-width'>
                        ...
                        <div className=' absolute full-width offset-down-5 offset-right-0 center ' >
                            ...
                            <div className='col-10 '>
                                ...
                                <h2 className='title font-iskra text-white '>MORE IMPRESSIONS</h2>
                                <h5 className='font-iskra normal-text text-white' >from the past years</h5>
                        ...
                        <div>
                            ...
                            <div className='row justify-content-center relative' >
                                ...
                                <div className='col-lg-6 col-10'>
                                    ...
                                    <h2 className='text-blue font-iskra title'>''THERE ARE NO DAYS LIKE SNOWDAYS''</h2>
