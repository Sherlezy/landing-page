                        ...
                        <div className='d-xs-block'>
                            ...
                            <div className='row justify-content-center relative offset-down5'>
                                ...
                                <div className='col-lg-4 col-8 m-2'>
                                    ...
                                    <div className='d-xs-block d-lg-none'>
                                        <h1 className='subtitle font-weight-bold text-white blue-shadow font-iskra'>COMING SOON</h1>

                                    </div>

                                    <div className='d-none d-lg-block'>
                                        <h1 className='subtitle font-weight-bold text-blue font-iskra'>COMING SOON </h1>
